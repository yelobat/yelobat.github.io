...
* DONE cses.fi - Missing Number
:PROPERTIES:
:EXPORT_AUTHOR: yelobat
:EXPORT_FILE_NAME: cses-fi-missing-number
...
can go back to see the solution to the [[/posts/cses-fi-weird-algorithm][weird algorthm]] problem.
...
[[/posts/cses-fi-weird-algorithm][weird algorthm]] where we used =u32= instead of =u64=, which resulted in an overflow
in our chosen type.
